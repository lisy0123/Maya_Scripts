...
## [:robot: Robot auto walking](https://github.com/lisy0123/Maya_Scripts/tree/master/Robot_auto_walking)
...
- [x] set in order => Solved by ordering it from the bottom, not from the top.
  - [ ] set in order: add options for multiple number

- [x] copy and new group
- [x] add/delete attribute
- [x] change attribute order/name
- [ ] add attribute for target visibility
- [x] spread constraint
  - [ ] spread constraint: sometimes come up with errors in the hierarchy
...
- [ ] ribbon
- [ ] joint copy for settitng(fk, ik, rig)/ik spline hybird
- [ ] quick body, mouth/eye rig
- [ ] copy/paste weight
- [ ] pyside/pyqt
